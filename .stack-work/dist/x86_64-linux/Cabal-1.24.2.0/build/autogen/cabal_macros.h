...
/* package Filesys-0.1.0.0 */
#define VERSION_Filesys "0.1.0.0"
#define MIN_VERSION_Filesys(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "Filesys-0.1.0.0"

#define CURRENT_PACKAGE_KEY "Filesys-0.1.0.0"
